...
<nav class="relative bg-gray-800 dark:bg-gray-800/50 dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10">
    ...
    <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3">
            <!-- Current: "bg-gray-900 dark:bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
            <a href="/" aria-current="page" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium dark:bg-gray-950/50">Home</a>
            <a href="blog" class="text-gray-300 hover:text-white block rounded-md px-3 py-2 text-base font-medium hover:bg-white/5">Blog</a>
            <a href="about" class="text-gray-300 hover:text-white block rounded-md px-3 py-2 text-base font-medium hover:bg-white/5 ">About</a>
            <a href="contact" class="text-gray-300 hover:text-white block rounded-md px-3 py-2 text-base font-medium hover:bg-white/5">Contact</a>
        </div>
    </el-disclosure>
</nav>